...
- 🔴 **CRITICAL: NEVER ask to push. NEVER bump or commit without an explicit order.**
...
- At the end of every task or upon making an error you MUST update the docs/lessons-learned.md file.
